...
% FONTS para evitar warnings de fuentes
\usepackage{lmodern}
...
% Páginas preliminares (resumen, índices) - Estilo APA simplificado
\fancypagestyle{preliminares}{
    \fancyhf{}
    \renewcommand{\headrulewidth}{0pt}
    \renewcommand{\footrulewidth}{0pt}
    
    % Solo numeración romana centrada
    \fancyfoot[C]{\thepage}
}
...
\fancypagestyle{contenido}{
    ...
    \fancyfoot[R]{\small\textit{2025 - Concepción, Junín}}
...
% Asegurar que los capítulos mantengan el estilo uniforme
\makeatletter
\renewcommand{\chapter}{%
  \if@openright\cleardoublepage\else\clearpage\fi
  \thispagestyle{contenido}%  % Forzar estilo uniforme en todas las páginas de capítulo
  \global\@topnum\z@
  \@afterindentfalse
...
% ÍNDICES CON NUMERACIÓN ROMANA - ESTILO APA
\newpage
\pagenumbering{roman}
